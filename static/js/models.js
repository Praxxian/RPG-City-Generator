class CitySize {
    constructor(name, avgSize, maxEmployees) {
        this.name = name;
...
class Caste {
    constructor(name, ageRandom, infantMortality) {
        this.name = name;
...
Caste.PEASANT = new Caste('Peasant', new BoxMullerRandom(0.0, 20.0), 0.2);
Caste.TRADESMEN = new Caste('Tradesmen', new BoxMullerRandom(0.0, 25.0), 0.15);
Caste.MERCANTILE = new Caste('Mercantile', new BoxMullerRandom(0.0, 30.0), 0.05);
Caste.NOBLE = new Caste('Noble', new BoxMullerRandom(0.0, 35.0), 0.02);
class Prosperity {
    toString() {
        return this.Label;
    }
...
class BusinessTypeUtil {
    static getInventory(businessType) {
        switch (businessType) {
