...
const Race = {
    DRAGONBORN: { name: 'Dragonborn', firstNameMaleList: FirstNamesMaleDragonborn, firstNameFemaleList: FirstNamesFemaleDragonborn, lastNameList: LastNamesDragonborn },
    DWARF: { name: 'Dwarf', firstNameMaleList: FirstNamesMaleDwarf, firstNameFemaleList: FirstNamesFemaleDwarf, lastNameList: LastNamesDwarf },
    ELF: { name: 'Elf', firstNameMaleList: FirstNamesMaleElf, firstNameFemaleList: FirstNamesFemaleElf, lastNameList: LastNamesElf },
    GNOME: { name: 'Gnome', firstNameMaleList: FirstNamesMaleGnome, firstNameFemaleList: FirstNamesFemaleGnome, lastNameList: LastNamesGnome },
    HALF_ELF: { name: 'Half-Elf', firstNameMaleList: FirstNamesMaleElf.concat(randomSample(FirstNamesMale, FirstNamesMale.length / 2)), firstNameFemaleList: FirstNamesMaleElf.concat(randomSample(FirstNamesMale, FirstNamesMale.length / 2)), lastNameList: LastNames.concat(LastNamesElf) },
    HALFLING: { name: 'Halfling', firstNameMaleList: FirstNamesMaleHalfing, firstNameFemaleList: FirstNamesFemaleHalfing, lastNameList: LastNamesHalfing },
    HALF_ORC: { name: 'Half-Orc', firstNameMaleList: FirstNamesMaleHalfOrc, firstNameFemaleList: FirstNamesFemaleHalfOrc, lastNameList: LastNamesHalfOrc },
    HUMAN: { name: 'Human', firstNameMaleList: FirstNamesMale, firstNameFemaleList: FirstNamesFemale, lastNameList: LastNames },
    TIEFLING: { name: 'Tiefling', firstNameMaleList: FirstNamesMaleTiefling, firstNameFemaleList: FirstNamesFemaleTiefling, lastNameList: LastNamesTiefling },
    AARAKOCRA: { name: 'Aarakocra', firstNameMaleList: FirstNamesMaleAarakocra, firstNameFemaleList: FirstNamesFemaleAarakocra, lastNameList: LastNamesAarakocra },
    GENASI: { name: 'Genasi', firstNameMaleList: FirstNamesMaleGenasi, firstNameFemaleList: FirstNamesFemaleGenasi, lastNameList: LastNamesGenasi },
    GOLIATH: {
        name: 'Goliath', firstNameMaleList: FirstNamesMaleGoliath, firstNameFemaleList: FirstNamesFemaleGoliath, lastNameList: LastNamesGoliath
        , nicknamePrefix: ['Bear', 'Dawn', 'Flint', 'Horn', 'Keen', 'Lone', 'Long', 'Root', 'Sky', 'Steady', 'Thread', 'Twisted', 'Word', 'Owl', 'Panther', 'Rat'
            , 'Hare', 'Fox', 'Otter', 'Badger', 'Horse', 'Mule', 'Boar', 'Deer', 'Bear', 'Elk', 'Ox', 'Lynx', 'Wolf', 'Crane', 'Eagle', 'Toad'
            , 'Snake', 'Mountain', 'Hill', 'Star', 'Crow']
        , nicknameSuffix: ['killer', 'caller', 'finder', 'carver', 'eye', 'hunter', 'leaper', 'smasher', 'watcher', 'hand', 'twister', 'limb', 'painter', 'seeker', 'speaker']
    },
    AASIMAR: { name: 'Aasimar', firstNameMaleList: FirstNamesMale, firstNameFemaleList: FirstNamesFemale, lastNameList: LastNames },
    BUGBEAR: { name: 'Bugbear', firstNameMaleList: FirstNamesMaleInverse, firstNameFemaleList: FirstNamesFemaleInverse, lastNameList: LastNamesInverse },
    FIRBOLG: { name: 'Firbolg', firstNameMaleList: FirstNamesMaleElf, firstNameFemaleList: FirstNamesFemaleElf, lastNameList: LastNamesElf },
    GOBLIN: { name: 'Goblin', firstNameMaleList: FirstNamesMaleInverse, firstNameFemaleList: FirstNamesFemaleInverse, lastNameList: LastNamesInverse },
    HOBGOBLIN: { name: 'Hobgoblin', firstNameMaleList: FirstNamesMaleInverse, firstNameFemaleList: FirstNamesFemaleInverse, lastNameList: LastNamesInverse },
    KENKU: { name: 'Kenku', firstNameMaleList: FirstNamesKenku, firstNameFemaleList: FirstNamesKenku, lastNameList: FirstNamesKenku },
    KOBOLD: { name: 'Kobold', firstNameMaleList: FirstNamesKobold, firstNameFemaleList: FirstNamesKobold, lastNameList: FirstNamesKobold },
    LIZARDFOLK: { name: 'Lizardfolk', firstNameMaleList: FirstNamesLizardFolk, firstNameFemaleList: FirstNamesLizardFolk, lastNameList: FirstNamesLizardFolk },
    ORC: { name: 'Orc', firstNameMaleList: FirstNamesMaleOrc, firstNameFemaleList: FirstNamesFemaleOrc, lastNameList: LastNamesOrc },
    TABAXI: { name: 'Tabaxi', firstNameMaleList: FirstNamesTabaxi, firstNameFemaleList: FirstNamesTabaxi, lastNameList: LastNames },
    TRITON: { name: 'Triton', firstNameMaleList: FirstNamesMaleTriton, firstNameFemaleList: FirstNamesFemaleTriton, lastNameList: LastNamesTriton },
    YUANTI_PUREBLOOD: { name: 'Yuanti Pureblood', firstNameMaleList: FirstNamesYuanTi, firstNameFemaleList: FirstNamesYuanTi, lastNameList: FirstNamesYuanTi },
    TORTLE: { name: 'Tortle', firstNameMaleList: FirstNamesTortle, firstNameFemaleList: FirstNamesTortle, lastNameList: FirstNamesTortle },
    GITH: { name: 'Gith', firstNameMaleList: FirstNamesMaleGith, firstNameFemaleList: FirstNamesFemaleGith, lastNameList: FirstNamesMaleGith.concat(FirstNamesFemaleGith) }
};
