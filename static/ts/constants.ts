...
const Races: { [name: string]: Race } = {
    ...
    GOLIATH: new Race(
        'Goliath', FirstNamesMaleGoliath, FirstNamesFemaleGoliath, LastNamesGoliath
        , ['Bear', 'Dawn', 'Flint', 'Horn', 'Keen', 'Lone', 'Long', 'Root', 'Sky', 'Steady', 'Thread', 'Twisted', 'Word', 'Owl', 'Panther', 'Rat', 'Hare', 'Fox', 'Otter', 'Badger', 'Horse', 'Mule', 'Boar', 'Deer', 'Bear', 'Elk', 'Ox', 'Lynx', 'Wolf', 'Crane', 'Eagle', 'Toad', 'Snake', 'Mountain', 'Hill', 'Star', 'Crow']
        , ['killer', 'caller', 'finder', 'carver', 'eye', 'hunter', 'leaper', 'smasher', 'watcher', 'hand', 'twister', 'limb', 'painter', 'seeker', 'speaker']),
...
const CitySizes: { [name: string]: CitySize } = {
...
const BusinessTypes: { [name: string]: BusinessType } = {
    ALCHEMIST_SHOP: <BusinessType>({
        name: 'Alchemist Shop',
    ...
    WAINWRIGHT_WORKSHOP: <BusinessType>({
